...
# Hình 2:  
- Dựng các dịch vụ bằng docker-compose  
...
# Hình 4:  
- Truy cập Node‑RED qua đường dẫn con   
...
# Tổng quan: 
Bài chọn hướng IoT “Giám sát mực nước”   
Sau bài này, em nắm được quy trình xây dựng một ứng dụng web IoT đầy đủ từ hạ tầng đến giao diện, củng cố kiến thức về container hóa, reverse proxy, thiết kế API,   mô hình dữ liệu (quan hệ vs chuỗi thời gian), xác thực người dùng và trực quan hóa dữ liệu. Em tự tin hơn với cách tư duy tích hợp nhiều dịch vụ và triển khai, kiểm thử chúng một cách hệ thống.  
